    ...
    public List<List<Item>> getDesktop() {
        ...
        if (cursor.moveToFirst()) {
            ...
            do {
                ...
                if (desktopVar == Definitions.ItemPosition.Desktop.ordinal() && stateVar == Definitions.ItemState.Visible.ordinal()) {
    ...
    private Item getSelection(Cursor cursor) {
        ...
        switch (type) {
            ...
            case SHORTCUT:
                ...
                App app = MainActivity.Companion.getAppLoader().findItemApp(item);
